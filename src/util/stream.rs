    ...
    T: ToSocketAddrs,
{
    match TcpStream::connect(addr).await {
        ...
        Err(e) => match e.kind() {
            ...
            ErrorKind::ConnectionRefused => Err(ReplyError::ConnectionRefused.into()),
            ErrorKind::ConnectionAborted => Err(ReplyError::ConnectionNotAllowed.into()),
            ErrorKind::ConnectionReset => Err(ReplyError::ConnectionNotAllowed.into()),
            ErrorKind::NotConnected => Err(ReplyError::NetworkUnreachable.into()),
